module SageoneSdk
  class Client
    ...
    module PurchaseInvoices
      ...
      #   @client.create_purchase_invoice(
      #     "contact_id" => "371",
      ...
      # @param options [hash]
      def create_purchase_invoice(data, _options = {})
      ...
      # @param options [hash]
      def update_purchase_invoice(id, data, _options = {})
      ...
      # @param options [hash]
      def delete_purchase_invoice(id, _options = {})
